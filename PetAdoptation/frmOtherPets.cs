...
{
    public partial class frmOtherPets : Form
    {
        public frmOtherPets()
        {
            InitializeComponent();
            ...
            //  GET Cat List
            List<Pet> otherList = petList.Where(pet => pet.Type == "Other").ToList();

            //  LIST all Pet in Pet list
            foreach (Pet p in otherList)
            {
        ...
        {
            this.Hide();
            frmMainScreen mainScreenForm = new frmMainScreen();
            mainScreenForm.Show();
        }
        ...
        private void Adopt_lb_Click(object sender, EventArgs e)
        {
